...
const About = () => {
    return (
        <section className='about'>
            ...
            Solidity and Javascript, going through web development tutorials and war-games like 
            Ethernauts, etc. All of this in hopes of landing a job in the space so I can spend more
            of my time contributing to the ecosystem!
            </p>
        </section>
    );
}
